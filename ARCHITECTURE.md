...
- Minimum API-nivå: Appen krever Android API-nivå [x] fordi
- Målrettet API-nivå: Android API-nivå [y] er anbefalt for å sikre optimal ytelse og bruk av de nyeste plattformsfunksjonene.
